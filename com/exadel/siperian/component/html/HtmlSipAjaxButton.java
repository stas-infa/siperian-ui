...
public class HtmlSipAjaxButton extends SipUIAjaxCommandButton{

public final static  String COMPONENT_FAMILY = "javax.faces.Command";

public final static  String COMPONENT_TYPE = "com.exadel.siperian.HtmlSipAjaxButton";
...
public HtmlSipAjaxButton(){
setRendererType("com.exadel.siperian.renderkit.SipAjaxButtonRendererBase");
}
...
state[35] = _onmouseup;
state[36] = saveAttachedState(context, _process);
state[37] = saveAttachedState(context, _reRender);
state[38] = _rel;
state[39] = Integer.valueOf(_requestDelay);
state[40] = Boolean.valueOf(_requestDelaySet);
state[41] = _rev;
state[42] = _shape;
state[43] = _similarityGroupingId;
state[44] = _status;
state[45] = _style;
state[46] = _styleClass;
state[47] = _tabindex;
state[48] = _target;
state[49] = Integer.valueOf(_timeout);
state[50] = Boolean.valueOf(_timeoutSet);
state[51] = _title;
state[52] = _type;
return state;
}
...
super.restoreState(context, states[0]);
	_accesskey = (String)states[1];;
		...
		_icon = (String)states[15];;
		_iconAlign = (String)states[16];;
		...
		_onblur = (String)states[23];;
		_onclick = (String)states[24];;
		_oncomplete = (String)states[25];;
		...
		_process = (Object)restoreAttachedState(context, states[36]);
		_reRender = (Object)restoreAttachedState(context, states[37]);
		_rel = (String)states[38];;
		_requestDelay = ((Integer)states[39]).intValue();
		_requestDelaySet = ((Boolean)states[40]).booleanValue();
		_rev = (String)states[41];;
		_shape = (String)states[42];;
		_similarityGroupingId = (String)states[43];;
		_status = (String)states[44];;
		_style = (String)states[45];;
		_styleClass = (String)states[46];;
		_tabindex = (String)states[47];;
		_target = (String)states[48];;
		_timeout = ((Integer)states[49]).intValue();
		_timeoutSet = ((Boolean)states[50]).booleanValue();
		_title = (String)states[51];;
		_type = (String)states[52];;
