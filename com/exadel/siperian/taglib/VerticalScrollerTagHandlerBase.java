...
public class VerticalScrollerTagHandlerBase extends ComponentHandler {
	 ...
	 private static final MetaRule pageRule = new MetaRule() {
			...
			public void applyMetadata(FaceletContext ctx, Object instance) {
				UIVerticalScroller datascroller = (UIVerticalScroller) instance;
		    ...
		    public VerticalScrollerTagHandlerBase(ComponentConfig config) {
			super(config);
		    }
