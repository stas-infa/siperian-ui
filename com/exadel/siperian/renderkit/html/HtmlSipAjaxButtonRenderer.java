...
import com.exadel.siperian.renderkit.SipAjaxButtonRendererBase;



/**
 * Renderer for component class com.exadel.siperian.renderkit.html.HtmlSipAjaxButtonRenderer
 */
public class HtmlSipAjaxButtonRenderer extends SipAjaxButtonRendererBase {

	public HtmlSipAjaxButtonRenderer () {
		super();
	}
...
protected InternetResource[] getScripts() {
   ...
   public void encodeIcon(FacesContext context, UIComponent component) throws IOException {
	...
	protected Class getComponentClass() {
		return com.exadel.siperian.component.SipUIAjaxCommandButton.class;
	}


	public void doEncodeEnd(ResponseWriter writer, FacesContext context, com.exadel.siperian.component.SipUIAjaxCommandButton component, ComponentVariables variables) throws IOException {
...
writer.writeComment(convertToString(" TODO nick - TBODY is missing "));
...
writer.endElement("table");
	...
	public void doEncodeEnd(ResponseWriter writer, FacesContext context, UIComponent component) throws IOException {
		...
		doEncodeEnd(writer, context, (com.exadel.siperian.component.SipUIAjaxCommandButton)component, variables );
