...
public class VerticalScrollerRenderer extends HeaderResourcesRendererBase {

    protected Class getComponentClass() {
        return UIVerticalScroller.class;
    }
    ...
    public void doDecode(FacesContext context, UIComponent component) {
    	...
    	if (param != null) {
    		UIVerticalScroller scroller = (UIVerticalScroller) component;
    ...
    public ControlsState getControlsState(FacesContext context,
            UIVerticalScroller datascroller, int pageIndex, int pageCount) {
        int minPageIdx = 1;
    ...
    public void renderPager(FacesContext context, UIComponent component, int pageIndex, int count)
        ...
        for (int i = 0; i < pageCount; i++) {
			...
			out.writeAttribute("id", parentId + ":tab:" + i, null);
            
            if (isCurrentPage) {
                out.writeAttribute("class", "tabActive "+
                		styleClass, null);
                out.writeAttribute("onclick", getOnClick(Integer.toString(i + 1)), null);
            } else {
                out.writeAttribute("class", "tabInActive "+
                		styleClass, null);
                out.writeAttribute("onclick", getOnClick(Integer.toString(i + 1)), null);
            }
    ...
    protected Map getParameters(FacesContext context, UIComponent component){
    	...
    	if(component instanceof UIVerticalScroller){
