...
//		this.field.setAttribute("readonly",true);
		...
		this.comboList = new Richfaces.SipComboBoxList(this.spacerImg,combobox,listId, parentListId, selectFirstOnUpdate, filterNewValue, this.classes.combolist, listWidth, 
	...
	setInputWidth : function() {
		...
		if (this.field.parentNode.style.width.indexOf('%') == -1) {
			...
			this.field.style.width = this.field.parentNode.style.width;
		}
	},
