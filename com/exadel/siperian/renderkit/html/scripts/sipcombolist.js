...
Richfaces.SipComboBoxList.prototype = {
	...
	initialize: function(spacerImg,comboboxId,listId, parentListId, selectFirstOnUpdate, filterNewValues, classes, width, height, itemsText, onlistcall, onlistclose, fieldId, shadowId,decorationId,
						 showDelay, hideDelay,countOfItems,isSipMode) {
...
//		items.shift();
    ...
    createShadowDiv:function(){
    	...
    	//add celspacing and etc attributes
...
//    	alert("spacerImg = "+this.spacerImg);
    ...
    createListPosition:function(){
   		 ...
   		 // decoration.setAttribute("style","border: 2px solid #000000;background:green;");
   		 this.list =  document.createElement('div');
   		 this.list.setAttribute("id",this.comboboxId+"list");
   		 this.list.setAttribute('class','sip-combobox-list-scroll');
   		  // this.list.setAttribute("style","border: 2px solid #000000;background:green;");
