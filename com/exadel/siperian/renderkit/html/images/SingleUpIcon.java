 ...
 *
 */
public class SingleUpIcon extends IconBase {
	...
	protected void paint(ResourceContext context, Graphics2D graphics) {
		...
		if (stored != null) {
			BufferedImage arrow = paintArrow(stored, false);
			...
			graphics.rotate(Math.toRadians(90), getDimensions(context).getWidth()/2, getDimensions(context).getHeight()/2);
