...
public class RichTableMenuRenderer extends TableMenuRenderer {
     ...
     * (non-Javadoc)
     * 
     * @see com.richfaces.siperian.renderkit.html.TableMenuRenderer#render()
     */
...
/*        // add menu items for sorting
        ...
        if((Boolean)table.getAttributes().get("allowColumnsHide")) {
            //menu.getChildren().add(sep);
...
/*            UIMenuGroup group = (HtmlMenuGroup) context.getApplication()
            ...
            while (columns.hasNext()) {
            	...
            	Object onhide = column.getAttributes().get("canHide");
            	boolean canBeHidden = true;
            	if (onhide instanceof Boolean) {
            		canBeHidden = (Boolean)onhide;
            	}else if (onhide instanceof String) {
            		canBeHidden = Boolean.valueOf(((String)onhide).toLowerCase());
            	}
            	if (canBeHidden) {
            		buildMenuItem(menu, column);
            	}
            }
        }
    }// buildMenu
     ...
     * (non-Javadoc)
     * 
     * @see com.richfaces.siperian.renderkit.html.TableMenuRenderer#createShowMenuEventFunction()
     */
