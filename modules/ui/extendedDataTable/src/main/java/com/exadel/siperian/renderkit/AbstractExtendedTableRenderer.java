...
public abstract class AbstractExtendedTableRenderer extends
    ...
    public static final String IMAGE_RESOURCE_PATH = "/com/exadel/siperian/renderkit/html/images/";
    ...
    public void encodeHeader(FacesContext context, UIExtendedDataTable table, int startColumns, int endColumn,
            boolean emptyCell)
            throws IOException {
     ...
     * @param writer ResponseWriter for this context
     * @param table table instance
     * @param headers iterator over headers in table
     * @param skinCellClass css class of skin
     * @param headerClass css class of header
     * @param facetName facet to encode
     * @param element element to encode
     * @throws IOException if ResponseWriter fails it's operation
     * @author pbuda
     */
     ...
     * colspan).
     * @param table to render false row to,
     * @param context of the table.
     * @throws IOException
     */
    ...
    private void encodeGroupAsset(FacesContext context, UIExtendedDataTable table, ExtendedTableHolder holder)
            throws IOException {
    ...
    public void encodeCell(FacesContext context, ExtendedTableHolder holder, UIColumn column, boolean first,
    ...
    protected void encodeModifiedState(FacesContext context, UIColumn column, ResponseWriter writer)
            throws IOException {
        ...
        if (column.getFacet("modifiedIcon") != null) {
            ...
            writer.writeAttribute("class", "extdt-cell-modified-img", null);
            writer.writeAttribute("src", getResource(IMAGE_RESOURCE_PATH + "modified.gif").getUri(context, null), null);
            writer.endElement(HTML.IMG_ELEMENT);
        }
    }
     ...
     * @param writer ResponseWriter for FacesContext
     * @param table table for which this row is being encoded
     * @param rowId new rowId to encode
     * @throws IOException if ResponseWriter fails
     */
    ...
    public String createClientDataTable(FacesContext context,
        ...
        if (table.getAttributes().get(ON_ROW_CONTEXT_MENU) != null) {
            scriptOptions.addOption(ON_ROW_CONTEXT_MENU,
                    new JSFunctionDefinition("event").addToBody(table.getAttributes().get(ON_ROW_CONTEXT_MENU)));
        }
        if (table.getAttributes().get("onscroll") != null) {
            scriptOptions.addOption(ON_SCROLL_FUNCTION,
                    new JSFunctionDefinition("event").addToBody(table.getAttributes().get("onscroll")));
        }
        ...
        int headerHeight = -1;
        if (table.getAttributes().get("headerHeight") != null) {
            headerHeight = (Integer) table.getAttributes().get("headerHeight");
        }
        scriptOptions.addOption("headerHeight", headerHeight);
        scriptOptions.addOption("modifiedData", table.hasModifiedData());
        scriptOptions
                .addOption("synchronizeHorizonalScrolling", table.getAttributes().get("synchronizeHorizonalScrolling"));
    ...
    protected void preDecode(FacesContext context, UIComponent component) {
        if (component instanceof com.exadel.siperian.component.UIExtendedDataTable) {
            com.exadel.siperian.component.UIExtendedDataTable table =
                    (com.exadel.siperian.component.UIExtendedDataTable) component;
    ...
    protected void doDecode(FacesContext context, UIComponent component) {
        ...
        if (component instanceof com.exadel.siperian.component.UIExtendedDataTable) {
            ...
            if (COL_RESIZE_ACTION_NAME.equals(map.get(COL_RESIZE_ACTION_NAME))
                    && map.get(component.getClientId(context) + ":columnWidths") != null) {
            ...
            if (GROUP_TOGGLE_ACTION_NAME.equals(map.get(GROUP_TOGGLE_ACTION_NAME))
                    && map.get(component.getClientId(context)) != null) {
                ...
                if (isAjax) {
                    ...
                    context.getExternalContext().getRequestMap()
                            .put(component.getId() + ROOT_ROW_AJAX_EXPANDED, rowKey);
                }
            ...
            if (EDIT_ACTIONE_NAME.equals(map.get(EDIT_ACTIONE_NAME))
                    && map.get(component.getClientId(context)) != null) {
    ...
    protected class G3HeaderEncodeStrategy implements HeaderEncodeStrategy {
        ...
        public void encodeBegin(FacesContext context, ResponseWriter writer,
            ...
            if (column instanceof UIColumn) {
                ...
                if (sortableColumn) {
                    writer.writeAttribute(HTML.onclick_ATTRIBUTE, "$('" + dataColumn.getParent().getClientId(context)
                            + "').component.OnCellMouseClicked(event)", null);
                    writer.startElement(HTML.SPAN_ELEM, column);
            ...
            if (column instanceof UIColumn) {
                ...
                if (sortableColumn) {
                    ...
                    if (Ordering.ASCENDING.equals(dataColumn.getSortOrder())) {
                        imageUrl = getResource(IMAGE_RESOURCE_PATH + ARROW_UP).getUri(context, null);
                    } else if (Ordering.DESCENDING.equals(dataColumn.getSortOrder())) {
                        imageUrl = getResource(IMAGE_RESOURCE_PATH + ARROW_DOWN).getUri(context, null);
                    } else if (dataColumn.isSelfSorted()) {
                        imageUrl = getResource(IMAGE_RESOURCE_PATH + ARROWS).getUri(context, null);
                    }
                ...
                writer.writeAttribute(HTML.onclick_ATTRIBUTE, "$('" + tableId + "').component.header.OnSepClick(event)",
                        null);
                writer.writeAttribute(HTML.onmousedown_ATTRIBUTE,
                        "$('" + tableId + "').component.header.OnSepMouseDown(event)", null);
                writer.writeAttribute(HTML.onmousemove_ATTRIBUTE,
                        "$('" + tableId + "').component.header.OnSepMouseMove(event)", null);
                writer.writeAttribute(HTML.onmouseup_ATTRIBUTE,
                        "$('" + tableId + "').component.header.OnSepMouseUp(event)", null);
                ...
                if ("header".equals(facetName) && (allowColmnsHide != null && (Boolean) allowColmnsHide)) {
                    ...
                    writer.writeAttribute(HTML.onmousedown_ATTRIBUTE,
                            "$('" + tableId + "').component.header.OnMenuImageMouseDown(event)", null);
    ...
    public void renderDropSupport(FacesContext context, UIColumn column,
        ...
        com.exadel.siperian.renderkit.html.TableDragDropRenderer renderer =
                com.exadel.siperian.renderkit.html.TableDragDropRenderer
                        .getInstance(context);
    ...
    public void encodeTableMenu(FacesContext context, com.exadel.siperian.component.UIExtendedDataTable table)
        ...
        com.exadel.siperian.renderkit.html.TableMenuRenderer menuRenderer =
                new com.exadel.siperian.renderkit.html.RichTableMenuRenderer();
        //comment sort group
