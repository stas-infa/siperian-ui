...
import com.exadel.siperian.renderkit.html.ExtendedRowsRenderer;
...
public class AbstractExtendedRowsRendererTest extends AbstractAjax4JsfTestCase {
    ...
    public void setUp() throws Exception {
        ...
        table = (UIExtendedDataTable) application
                .createComponent(com.exadel.siperian.component.UIExtendedDataTable.COMPONENT_TYPE);
    ...
    public void testProcess() {
        Object rowKey = 100;
        ExtendedTableHolder eth = new com.exadel.siperian.renderkit.ExtendedTableHolder(table);
