...
public abstract class UIModalPanel extends UIInput {
	...
	public static final String COMPONENT_TYPE = "com.exadel.siperian.ModalPanel";
	
	public static final String COMPONENT_FAMILY = "com.exadel.siperian.ModalPanel";
	...
	public abstract void setShowCloseButton(boolean showCloseButton);
	...
	public abstract String getPanelDOMAttachment();
	public abstract void setPanelDOMAttachment(String panelDOMAttachment);

	public abstract boolean isIsModal ();
	public abstract void setIsModal(boolean isModal);
