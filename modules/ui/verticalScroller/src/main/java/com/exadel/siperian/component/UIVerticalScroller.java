...
//TODO nick - why not just extend UIDataScroller?
public abstract class UIVerticalScroller extends AjaxActionComponent
implements DataScrollerSource, ActionSource {

	private static final Log log = LogFactory.getLog(UIVerticalScroller.class);
	
	private Integer page;

	public static final String COMPONENT_TYPE = "com.exadel.siperian.VerticalScroller";
	public static final String COMPONENT_FAMILY = "com.exadel.siperian.VerticalScroller";
	...
	public abstract void setHeight(String h);
