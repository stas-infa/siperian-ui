            ...
            <rich:column id="firstName"
                ...
                <h:outputText id="text" value="#{patient.firstName}" >
                    <rich:toolTip for="text" >
                        <h:outputText value="Right click for context menu" />
                    </rich:toolTip>
                    
                    <rich:contextMenu submitMode="ajax" id="menu" attachTo="text" event="oncontextmenu">
    					<rich:menuItem ajaxSingle="true" value="Patient: #{patient.lastName}  #{patient.lastName}  info">                    		                  
                		</rich:menuItem>
                		<rich:menuGroup value="Actions">  
                			<rich:menuItem ajaxSingle="true">
                    			Remove record
                    			<a4j:actionparam name="clear" assignTo="#{extendedDataTableBean.history}" value="Remove record : #{patient.lastName}  #{patient.lastName} " />                   	
                			</rich:menuItem>
                			<rich:menuItem value="View history" ajaxSingle="true">
                				<a4j:actionparam name="assign" assignTo="#{extendedDataTableBean.history}" value="View history for: #{patient.lastName}  #{patient.lastName} " />
                			</rich:menuItem>                
			            </rich:menuGroup>
        			</rich:contextMenu>
                </h:outputText>
